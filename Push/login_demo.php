    ...
    <div class="container">
       <div class="form-box <?= isActiveForm('login', $activeForm); ?>" id="login-form">  <!-- Login page starts here -->
            <form action="login_register.php" method="post">
                ...
                <p>Dont have a account? <a href="#" onclick="showForm('register-form')">Register</a></p> <!--Js called-->
            </form>
        </div>
        ...
        <div class="form-box <?= isActiveForm('register', $activeForm); ?>" id="register-form">  <!--Register page starts here -->
            <form action="login_register.php" method="post">
                ...
                <p> Already have an account ?<a href="#" onclick="showForm('login-form')"> Login</a> </p><!--Js called-->
